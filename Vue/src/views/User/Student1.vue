  ...
  <div class="add-user">
    ...
    <el-form ref="form" :model="user" :rules="rules" label-width="200px">
      ...
      <el-form-item label="科研经历" prop="research">
        <el-input v-model="user.research" class="large-input"></el-input>
      </el-form-item>
      <el-form-item label="学生骨干服务岗位" prop="backbone">
        <el-input v-model="user.backbone" class="large-input"></el-input>
      </el-form-item>
      <el-form-item label="社会实践经历" prop="social">
        <el-input v-model="user.social" class="large-input"></el-input>
      </el-form-item>
      <el-form-item label="志愿服务经历" prop="event">
        <el-input v-model="user.event" class="large-input"></el-input>
      </el-form-item>
      <el-form-item label="个人学年总结" prop="summary">
        <el-input v-model="user.summary" class="large-input"></el-input>
      </el-form-item>
